...
Los resultados cuantitativos de estas simulaciones contrafactuales, evaluados en el mismo período límite de parada de referencia $\tau^{\mathrm{hyp}}$, se resumen en la Tabla~\ref{tab:calibracion-resumen-novoice}. Al momento de la parada de referencia, la creencia posterior del tipo verdadero alcanza niveles muy elevados en DC ($\mu_{35} \approx 0{,}997$), PAR ($\mu_{105} \approx 1{,}000$) y ELN ($\mu_{75} \approx 0{,}985$), mientras que en FARC el aprendizaje más lento resulta en una creencia de tan solo $\mu_{20} \approx 0{,}463$. Esto ilustra el retardo en la velocidad de concentración del posterior inducido por la pérdida de la información acústica, forzando un horizonte de interacción mucho más largo antes de lograr el cierre.
...
\midrule
DC & 0.350 & 0.997 & 0.802 & 0.600 & 35 & Pago \\
PAR & 0.150 & 1.000 & 0.730 & 0.658 & 105 & Rescate \\
ELN & 0.250 & 0.985 & 0.734 & 0.666 & 75 & Liberación \\
