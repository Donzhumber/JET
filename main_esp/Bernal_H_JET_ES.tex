...
Para evaluar la robustez y suficiencia del mecanismo de identificación, esta sección analiza las simulaciones dinámicas bajo la exclusión contrafactual del canal de comunicación de voz, diferenciándose de la Sección~\ref{sec:calibracion} en que se elimina por completo la información acústica ($V_t = 0$ para todo $t$). Mientras que en la calibración de referencia de la Sección~\ref{sec:calibracion} la actualización bayesiana del Estado incorpora tanto las señales físico-institucionales de riesgos competitivos (desenlaces de maduración y riesgos) como las llamadas de voz, aquí aislamos los canales físico-institucionales endógenos desactivando la retroalimentación de verosimilitud de la comunicación. Bajo esta configuración, la única fuente de aprendizaje para el Estado consiste en las señales generadas por los riesgos competitivos del MDG ($\lambda_j$), con el objetivo de verificar si la creencia posterior $\mu_t$ converge al tipo de captor verdadero $\theta_K^\ast$ basándose únicamente en estos desenlaces, validando que el mecanismo es autosuficiente para la identificación.
