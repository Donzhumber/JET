...
Estas cuatro contribuciones teóricas se someten a validación aplicada en las Secciones~\ref{sec:application}--\ref{sec:calibracion}, que mapean el entorno abstracto al secuestro extorsivo en Colombia. Las estimaciones de logit multinomial y de riesgos competitivos, obtenidas a partir de los microdatos del Centro Nacional de Memoria Histórica documentados por \citet{cnmh_datos}, proveen los hazards específicos por tipo. Con esa huella empírica, las calibraciones de DC, PAR, ELN y FARC reportan las trayectorias posteriores, las sendas de instrumentos, la ganancia informacional y el cumplimiento de las restricciones IR e IC. Esta aplicación constituye así una capa de validación, y no la primitiva teórica del mecanismo.
