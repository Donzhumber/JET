...
% =========================================================================
% APPENDIX C -- FORMAL PROOFS AND LEAN VERIFICATION
...
\newcommand{\tabsource}{\ \textit{Source:} Analytical proofs in this supplement;
  Lean identifiers in \texttt{lean/Appendix3Proofs.lean}. Software: Lean~4
...
\href{mailto:hbernalc@universidadmayor.edu.co}{hbernalc@universidadmayor.edu.co}
and \href{mailto:hbernal@uniandes.edu.co}{hbernal@uniandes.edu.co}.
\end{funding}
...
\texttt{lean/} (main file \texttt{Appendix3Proofs.lean}) that
...
\texttt{tex/Appendix\_3.tex}. Machine-checked algebraic steps are reproduced by
the Lean~4 project in \texttt{lean/}. Set the working directory to
\texttt{Appendix\_3/} and run \texttt{replicate.sh}. See \texttt{README.txt} at the
...
\item Main formal file: \texttt{lean/Appendix3Proofs.lean}. Project metadata:
...
\item (Optional) Compile \texttt{tex/Appendix\_3.pdf} from \texttt{tex/} with
...
\texttt{Appendix\_3/}; see \texttt{README.txt} for the full build workflow.
\end{sloppypar}
